...
namespace HYM.System.library
{
    ...
    public class Camera3DComponents : Microsoft.Xna.Framework.GameComponent, ICameraInterface
    {
        ...
        public Vector3 Forward { get { return cameraPosition; } }
        public Vector3 UpVector { get { return cameraUp; } }
            ...
            : base(game)
        {
            ...
            projection = Matrix.CreatePerspectiveFieldOfView(MathHelper.PiOver4, (float)Game.Window.ClientBounds.Width / (float)Game.Window.ClientBounds.Height, 1.0f, 1000.0f);
        }
